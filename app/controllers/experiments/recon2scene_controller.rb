class Experiments::Recon2sceneController < ApplicationController
  require 'action_view'
  ...
  def results
    render "experiments/recon2scene/results", layout: true
  end

  def view
    render "experiments/recon2scene/view", layout: true
  end
