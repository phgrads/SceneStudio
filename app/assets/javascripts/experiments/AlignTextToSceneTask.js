...
define([
  ...
  {
    /**
     * Text to Scene align task
     * - User is show a series of 3D scenes
     *   and asked to match the text to objects in the scene
     */
    function AlignTextToSceneTask(params)
    {
      this.entryIndex = 0;
    ...
    AlignTextToSceneTask.prototype.saveSceneCallback = function(app, on_success, on_error) {
    ...
    AlignTextToSceneTask.prototype.closeSceneCallback = function(app) {
      this.next();
    };

    AlignTextToSceneTask.prototype.saveScene = function(app, on_success, on_error) {
    ...
    AlignTextToSceneTask.prototype.showComments = function() {
      // Hide rest of UI
      $('#ui').hide();
      // Show comment area
      $('#comment').show();
    ...
    AlignTextToSceneTask.prototype.showCoupon = function() {
      // TODO: Improve coupon
    ...
    AlignTextToSceneTask.prototype.next = function() {
      this.entryIndex++;
    ...
    AlignTextToSceneTask.prototype.showEntry = function(i) {
    ...
    AlignTextToSceneTask.prototype.start = function() {
      this.taskInstructions.hide();
      this.mturkOverlay.show();
      this.showEntry(this.entryIndex);
    };

    AlignTextToSceneTask.prototype.showInstructions = function() {
      // TODO: Show instructions
    };

    AlignTextToSceneTask.prototype.Launch = function() {
      this.showInstructions();
    };

    // Exports
    return AlignTextToSceneTask;
});
