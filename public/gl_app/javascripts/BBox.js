...
/**
 * @returns {number} radius of sphere circumscribing BBox
 */
...
BBox.prototype.RandomPointInside = function() {
    var x = this.mins[0] + Math.random() * (this.maxs[0] - this.mins[0]);
    var y = this.mins[1] + Math.random() * (this.maxs[1] - this.mins[1]);
    var z = this.mins[2] + Math.random() * (this.maxs[2] - this.mins[2]);
